...
export class ProductService {
    ...
    getProducts() {
      let ambienteFinal = ambiente.getAmbiente();
        return fetch(ambienteFinal+'/users').then(res => res.json()).then(d => d.data);
    }
    updateProducts(data={}){
      let ambienteFinal = ambiente.getAmbiente();
      let url = ambienteFinal;
    ...
    deleteProducts(data={}){
      ...
      let url = ambienteFinal;
        async function postData(url = '', data = {}) {
          ...
          postData(url+'/users/delete/', data)
            .then((data) => {
              console.log(data); // JSON data parsed by `data.json()` call
            });
    }
    insertProduct(data={}){
      ...
      let url = ambienteFinal;
        async function postData(url = '', data = {}) {
          ...
          postData(url+'/users/insert/', data)
            .then((data) => {
              console.log(data); // JSON data parsed by `data.json()` call
            });
    }
